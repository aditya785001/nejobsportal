      ...
      <div className="container-main py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              {["Jobs", "Results", "Admissions", "Scholarships", "Study Materials", "Exam Prep"].map(
                (item) => (
                  <li key={item}>
                    <Link
          ...
          <div>
            ...
            <ul className="space-y-2">
              {[
                ...
                { label: "Scheme Finder", href: "/scheme-finder" },
                ...
                { label: "BG Remover", href: "/tools/background-remover" },
              ].map((item) => (
                <li key={item.label}>
                  <Link
                    href={item.href}
        ...
        <div className="mt-8 pt-8 border-t border-gray-800 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-sm text-gray-500">
            &copy; {new Date().getFullYear()} NEJobsPortal.in. {t("footer.all-rights", language)}
          </p>
          <div className="flex items-center gap-4">
            {[
              { href: siteConfig.links.telegram, label: "Telegram", icon: "telegram" },
              { href: siteConfig.links.whatsapp, label: "WhatsApp", icon: "whatsapp" },
              { href: siteConfig.links.facebook, label: "Facebook", icon: "facebook" },
              { href: siteConfig.links.twitter, label: "X", icon: "twitter" },
        ...
        <p className="text-xs text-gray-600 mt-4 text-center">
          This is a free job alert portal. We are not a recruitment agency.
        </p>
      </div>
    </footer>
  );
